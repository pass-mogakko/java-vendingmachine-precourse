...
- [x] 기능3 단위테스트 : (자판기 설정) 투입 금액 저장
    - [x] 투입 금액 저장 성공 (0개인 경우, 동전으로 나누어떨어지지 않는 경우도 저장)
    - [x] 투입 금액 저장_투입 금액이 0보다 작으면 예외 발생
- [x] 기능4 단위테스트 : (상품 구매) 상품 개수, 투입 금액 변경
    - [x] 상품 구매_성공
    - [x] 상품 구매_존재하지 않는 상품명이면 예외 발생
    - [x] 상품 구매_상품의 수량이 0이면 예외 발생
- [ ] 기능5 단위테스트 : (상품 구매) 자판기의 구매 가능 상태 확인
    - [ ] 구매 가능 확인_참
    - [ ] 구매 가능 확인_남은 투입 금액이 상품 최저 가격보다 작으면 거짓
    - [ ] 구매 가능 확인_남은 상품 수량이 0이면 거짓
