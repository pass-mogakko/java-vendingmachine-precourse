...
- [ ] `입력 UI` : 자판기가 보유하고 있는 금액 입력받기
  - [ ] `exception` : 금액이 숫자가 아닐 경우 예외 처리
  - [ ] `exception` : 금액이 양의 정수가 아닐 경우 예외 처리

- [ ] 자판기가 보유하고 있는 금액으로 동전 무작위 생성
- [ ] `출력 UI` : 자판기가 보유하고 있는 동전 출력


### 상품 등록

- [ ] `입력 UI` : 상품명, 가격, 수량 입력받기
  - [ ] `exception` : 상품 가격 유효성 검사 - 100원 이상이며 10원 단위로 나누어떨어지는 값인지 확인, 아니면 예외 처리
  - [ ] `exception` : 상품명이 온전한 한글이 아니거나 특수문자, 공백으로 이루어진 경우 예외 처리
  - [ ] `exception` : 수량이 1 이상이 아닐 경우 예외 처리
...
- [ ] `입력 UI` : 투입 금액 입력받기
  - [ ] `exception` : 투입 금액이 숫자가 아닐 경우 예외 처리
  - [ ] `exception` : 투입 금액이 양의 정수가 아닐 경우 예외 처리
